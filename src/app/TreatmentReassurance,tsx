...
export const TrustReassurance: React.FC = () => {
  ...
  return <div className="bg-[#EAF1F7] py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {pillars.map((pillar, index) => <div key={index} className="bg-white p-8 rounded-sm shadow-sm hover:shadow-md transition-shadow duration-300 border border-white hover:border-[#C8A45A]/20">
              <div className="text-[#C8A45A] mb-6 inline-block p-3 bg-[#F7F2E8] rounded-sm">
                {pillar.icon}
              </div>
        ...
        <div className="mt-16 bg-[#0E3F73] p-1 rounded-sm">
          <div className="bg-[#0E3F73] border border-[#C8A45A]/30 p-8 md:p-12 text-center">
